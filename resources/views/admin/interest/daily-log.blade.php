    ...
    <div class="mb-6 bg-white p-4 rounded-lg shadow">
        <form method="GET" action="{{ route('admin.interest.daily-log') }}" class="flex items-center space-x-4">
            ...
            <div class="pt-6">
                ...
                <a href="{{ route('admin.interest.daily-log') }}" class="ml-2 bg-gray-600 text-white px-4 py-2 rounded hover:bg-gray-700">
                    Clear
                </a>
            </div>
        </form>
                                ...
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 h-10 w-10">
                                        <div class="h-10 w-10 rounded-full bg-gray-300 flex items-center justify-center">
                                            <span class="text-sm font-medium text-gray-700">{{ substr($log->user->name, 0, 2) }}</span>
                                        </div>
                                    </div>
                                    <div class="ml-4">
