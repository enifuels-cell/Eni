...
<div class="container mx-auto px-6 py-8">
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900">Approved Withdrawals</h1>
        <p class="mt-2 text-gray-600">History of approved withdrawal requests</p>
    </div>
    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <div class="text-sm text-gray-600">
                                    {{ $withdrawal->user->account_number ?? 'N/A' }}
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                {{ $withdrawal->processed_at ? $withdrawal->processed_at->format('M d, Y g:i A') : 'N/A' }}
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
        ...
        @else
            <div class="text-center py-12">
                <div class="text-gray-500 text-lg">No approved withdrawals found.</div>
                <p class="text-gray-400 mt-2">No withdrawal requests have been approved yet.</p>
            </div>
        @endif
    </div>
</div>
