...
class AdminDashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        // This is a value that has been or is about to be paid out.
        $totalActiveWithdrawal = Transaction::where('type', 'withdrawal')
        ...
        return view('admin.dashboard', compact(
            ...
            'totalActiveDeposit', 'totalActiveWithdrawal'
            // ******************************
        ));
    }
